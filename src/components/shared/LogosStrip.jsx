const logos = ['Imaginary Space', 'SMART 11', '☐ Whiteboard', 'dolche', 'Talentblocks', 'ClearEstate', 'Stepler', 'Imaginary Space', 'SMART 11', '☐ Whiteboard', 'dolche', 'Talentblocks']
    ...
    <section className="py-[60px] bg-white dark:bg-slate-950 border-t border-gray-200 dark:border-slate-800 transition-colors duration-300">
      <div className="max-w-[1280px] mx-auto px-6">
        <p className="text-center text-gray-500 dark:text-slate-400 text-[15px] max-w-[720px] mx-auto mb-10 leading-[1.7]">
          ...
          <a href="#" className="text-orange-600 no-underline hover:underline font-semibold">ClearEstate</a> and{' '}
          <a href="#" className="text-orange-600 no-underline hover:underline font-semibold">Stepler</a> increase efficiency by up to 78% while giving management total peace of mind to focus on scaling.
        </p>
