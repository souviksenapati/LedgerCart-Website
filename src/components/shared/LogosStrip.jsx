const logos = ['Lenskart', 'Recko', 'Arka2050', 'Karkhana.io', 'Intugine', 'mCaffeine', 'Zepto', 'Freecharge']
    ...
    <section className="py-[60px] bg-white dark:bg-[#0a0f1a] transition-colors duration-300">
      <div className="max-w-[1280px] mx-auto px-6">
        <p className="text-center text-gray-500 dark:text-slate-400 text-[15px] max-w-[720px] mx-auto mb-10 leading-[1.7]">
          ...
          <a href="#" className="text-orange-600 no-underline hover:underline font-semibold">Intugine Technologies</a> and{' '}
          <a href="#" className="text-orange-600 no-underline hover:underline font-semibold">Recko</a> increase efficiency by up to 78% while giving management total peace of mind to focus on scaling.
        </p>
