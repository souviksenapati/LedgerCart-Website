import ecommerceWebp from '../../../assets/features/ecommerce_dashboard_1776881354454.webp'
import b2bWebp from '../../../assets/features/b2b_wholesale_portal_1776881380752.webp'
import wmsWebp from '../../../assets/features/warehouse_logistics_wms_1776881410156.webp'
import erpWebp from '../../../assets/features/financial_erp_dashboard_1776881436517.webp'

const imgVisual = (webpSrc, altText) => (
  <img
    src={webpSrc}
    alt={altText}
    loading="lazy"
...
const modules = [
  {
    ...
    visual: imgVisual(ecommerceWebp, 'LedgerCart E-commerce storefront dashboard'),
    reverse: false
  },
  {
    ...
    visual: imgVisual(ecommerceWebp, 'Marketing and promotional campaign engine dashboard'),
    reverse: true
  },
  {
    ...
    visual: imgVisual(b2bWebp, 'B2B wholesale partner portal interface'),
    reverse: false
  },
  {
    ...
    visual: imgVisual(wmsWebp, 'Warehouse and logistics management system dashboard'),
    reverse: true
  },
  {
    ...
    visual: imgVisual(b2bWebp, 'Procure-to-pay and purchase order management interface'),
    reverse: false
  },
  {
    ...
    visual: imgVisual(erpWebp, 'Financial ERP dashboard with revenue and payables tracking'),
    reverse: true
  },
  {
    ...
    visual: imgVisual(erpWebp, 'PDF document generation and print-ready invoice system'),
    reverse: false
  },
  {
    ...
    visual: imgVisual(wmsWebp, 'Enterprise role-based access control and security dashboard'),
    reverse: true
  },
  {
    ...
    visual: imgVisual(ecommerceWebp, 'SaaS multi-tenant operations console and subscription management'),
    reverse: false
  }
]
